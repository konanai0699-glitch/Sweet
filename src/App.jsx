...
const CATEGORIES = [
  ...
  { id:"mamoul",   icon:"🌸", name:"معمول وموسمي", desc:"نكهات الموسم",      bg:"#FDF0FF", accent:"#A87BC0"  },
...
const PRODUCTS = {
  // ── كعك يومي (10) ────────────────────────────────────────────
  daily: [
    { id:"d1",  ...img("daily",1),  name:"تشكيلة حلويات فردية ملوّنة", desc:"تشكيلة جميلة من الحلويات الفردية بألوان لافتة وإضافات متنوعة", sizes:["كبير","وسط","صغير"], notes:["يُحضّر طازج يومياً","قابل للتخصيص"] },
    { id:"d2",  ...img("daily",2),  name:"كعكة الشوكولاتة الغنية",      desc:"كعكة شوكولاتة فاخرة مع طبقات كريمية متعددة وزينة احترافية",    sizes:["كبير","وسط"],        notes:["يُحضّر طازج يومياً","يُطلب قبل 24 ساعة"] },
    { id:"d3",  ...img("daily",3),  name:"تارت الفواكه الطازجة",         desc:"قاعدة تارت هشّة مع كريمة ناعمة ومزيّنة بالتوت الطازج",          sizes:["كبير","وسط","صغير"], notes:["يُحضّر طازج يومياً","موسمي حسب الفاكهة"] },
    { id:"d4",  ...img("daily",4),  name:"ميني كيك بيضاء أنيقة",        desc:"كيكات صغيرة ناعمة بتغطية بيضاء وزينة راقية",                    sizes:["وسط","صغير"],        notes:["يُطلب قبل 24 ساعة"] },
    { id:"d5",  ...img("daily",5),  name:"كيك الرول المحشو",             desc:"رول منفوش محشو بالكريمة الناعمة والمكسرات المحمّصة",              sizes:["كبير","وسط"],        notes:["يُحضّر طازج يومياً"] },
    { id:"d6",  ...img("daily",6),  name:"كريم برولي كلاسيكي",          desc:"كاسات كريم برولي ذهبية اللون بسطح كراميل محروق طازج",            sizes:["صغير"],              notes:["يُحضّر طازج يومياً","يُطلب قبل 24 ساعة"] },
    { id:"d7",  ...img("daily",7),  name:"صندوق تشكيلة فاخرة",          desc:"صندوق مُختار من أجود أصناف الحلويات اليومية مرتّبة بعناية",       sizes:["كبير","وسط"],        notes:["يُطلب قبل 48 ساعة","قابل للتخصيص"] },
    { id:"d8",  ...img("daily",8),  name:"براونيز بالمكسرات",           desc:"براونيز طرية وغنية بالشوكولاتة محشوة بالجوز والبندق",             sizes:["كبير","وسط","صغير"], notes:["يُحضّر طازج يومياً"] },
    { id:"d9",  ...img("daily",9),  name:"تشيز كيك بيري",               desc:"تشيز كيك كريمي مع صلصة التوت الحمراء وزينة فاكهية",              sizes:["كبير","وسط"],        notes:["يُطلب قبل 24 ساعة","موسمي"] },
  ...
  // ── كعك مناسبات (8) ─────────────────────────────────────────
  occasion: [
    { id:"o1",  ...img("occasion",1),  name:"كيك السفرة الطولي",             desc:"كيك سفرة فاخر بشكل طولي مميز مع تغطية احترافية",                 sizes:["كبير","وسط"],        notes:["يُطلب قبل 48 ساعة","قابل للتخصيص"] },
    { id:"o2",  ...img("occasion",2),  name:"صينية كنافة وحلويات شرقية",     desc:"صينية كبيرة من الكنافة وأصناف الحلويات الشرقية الفاخرة",          sizes:["كبير","وسط"],        notes:["يُطلب قبل 48 ساعة","مناسب للمناسبات"] },
    { id:"o3",  ...img("occasion",3),  name:"كيك الشوكولاتة المقلّم",        desc:"كيك شوكولاتة كلاسيكي بطبقات مقلّمة وزينة الفاكهة الطازجة",       sizes:["كبير","وسط"],        notes:["يُطلب قبل 48 ساعة"] },
    { id:"o4",  ...img("occasion",4),  name:"كيك عيد ميلاد Happy Birthday",  desc:"كيك عيد ميلاد احترافي مع كتابة وزينة أنيقة وطبقات كريمية",       sizes:["كبير","وسط"],        notes:["يُطلب قبل 48 ساعة","تصميم حسب الطلب"] },
    { id:"o5",  ...img("occasion",5),  name:"كيك الجاتو الكلاسيكي",         desc:"جاتو كلاسيكي بكريمة القشطة وكاكاو غني بمذاق لا يُنسى",           sizes:["كبير"],              notes:["يُطلب قبل 48 ساعة"] },
    { id:"o6",  ...img("occasion",6),  name:"كيك الجبن الياباني الفاخر",    desc:"كيك جبن ياباني طري كالسحاب بكاراميل ذهبي أو فاكهة موسمية",       sizes:["كبير","وسط"],        notes:["يُطلب قبل 48 ساعة","موسمي"] },
    { id:"o7",  ...img("occasion",7),  name:"كيك البقلاوة والعسل",          desc:"كيك مبتكر يجمع بين طبقات البقلاوة والكيك بالعسل والمكسرات",       sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع"] },
    { id:"o8",  ...img("occasion",8),  name:"كيك عيد ميلاد مزيّن",          desc:"كيك عيد ميلاد مزيّن بالورود والتوب والزينة الذهبية الفاخرة",      sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع","تصميم حسب الطلب"] },
  ],

  // ── معمول وموسمي (7) ────────────────────────────────────────
  mamoul: [
    { id:"m1",  ...img("mamoul",1),  name:"معمول التمر الملكي",            desc:"تمر فاخر بعجينة هشّة ومحشوة بالهيل والمكسرات",                   sizes:["كبير","وسط","صغير"], notes:["يُحضّر طازج يومياً","موسم رمضان والأعياد"] },
    { id:"m2",  ...img("mamoul",2),  name:"كرواسان الفستق",                desc:"كرواسان هشّ محشو بكريمة الفستق الطازج الفاخر",                    sizes:["وسط","صغير"],        notes:["يُطلب قبل 24 ساعة","يُحضّر طازج يومياً"] },
    { id:"m3",  ...img("mamoul",3),  name:"كوكيز بالشوكولاتة والمكسرات", desc:"كوكيز طازجة بعجينة سميكة وقطع شوكولاتة وفستق",                   sizes:["صغير"],              notes:["يُحضّر طازج يومياً"] },
    { id:"m4",  ...img("mamoul",4),  name:"صندوق لفائف الشوكولاتة",       desc:"لفائف عجين محشوة بالشوكولاتة الداكنة والمكسرات المحمّصة",          sizes:["كبير","وسط"],        notes:["يُطلب قبل 24 ساعة","هدية مميزة"] },
    { id:"m5",  ...img("mamoul",5),  name:"كوكيز التمر والقرفة",          desc:"كوكيز دافئة بالتمر الطبيعي والقرفة العطرة",                        sizes:["صغير"],              notes:["يُحضّر طازج يومياً","موسم الأعياد"] },
    { id:"m6",  ...img("mamoul",6),  name:"تارت الكراميل الفاخر",         desc:"تارت هشّة بحشوة الكراميل الكريمية الناعمة",                        sizes:["كبير","وسط"],        notes:["يُطلب قبل 24 ساعة"] },
    { id:"m7",  ...img("mamoul",7),  name:"معمول الجوز والقرفة",          desc:"جوز محمّص ممزوج بالقرفة العطرة في عجينة هشّة لا تقاوم",            sizes:["كبير","وسط","صغير"], notes:["يُطلب قبل 24 ساعة","موسم الأعياد"] },
  ],

  // ── طلبات خاصة (11) ─────────────────────────────────────────
  custom: [
    { id:"c1",  ...img("custom",1),  name:"كيك الورود الوردي",            desc:"كيك أنيق مُغطّى بورود الكريمة الوردية بتصميم زهري راقٍ",           sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع","تصميم حسب الطلب","تواصل عبر واتساب"] },
    { id:"c2",  ...img("custom",2),  name:"كيك الفراشات والذهب",          desc:"كيك مميز بالكريمة الوردية وزينة الفراشات الذهبية الفاخرة",          sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع","تصميم حسب الطلب"] },
    { id:"c3",  ...img("custom",3),  name:"كيك الفستق الأبيض",           desc:"كيك أنيق بالكريمة البيضاء الناعمة وزينة الفستق الأخضر",             sizes:["كبير"],              notes:["يُطلب قبل أسبوع","تصميم حسب الطلب"] },
    { id:"c4",  ...img("custom",4),  name:"كيك الأحمر الكلاسيكي",        desc:"ريد فيلفيت فاخر بإطار الكريمة البيضاء وزينة التوت الأحمر",          sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع"] },
    { id:"c5",  ...img("custom",5),  name:"كيك أرقام مميّز",             desc:"كيك بشكل الأرقام مع طبقات الكريمة والزينة الفاخرة",                 sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع","تصميم حسب الطلب"] },
    { id:"c6",  ...img("custom",6),  name:"كيك الباقة الزفافية",         desc:"كيك فاخر مزيّن بباقة الورد الطبيعي للمناسبات الكبرى",               sizes:["كبير"],              notes:["يُطلب قبل أسبوع","تواصل مباشرة عبر واتساب"] },
    { id:"c7",  ...img("custom",7),  name:"كيك مغطّى بالشوكولاتة",      desc:"كيك أسطواني بتغطية شوكولاتة داكنة وحلوى مبعثرة على السطح",          sizes:["كبير","وسط"],        notes:["يُطلب قبل 48 ساعة"] },
    { id:"c8",  ...img("custom",8),  name:"كيك Hello Kitty",             desc:"كيك مخصص بشخصية Hello Kitty الوردية لأصغر الأميرات",               sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع","تصميم حسب الطلب"] },
    { id:"c9",  ...img("custom",9),  name:"كيك الدبدوب الأبيض",         desc:"كيك أبيض أنيق مع دبدوب زينة وبالونات ذهبية لعيد الميلاد",           sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع","تصميم حسب الطلب"] },
    { id:"c10", ...img("custom",10), name:"كيك الزهور والورود",          desc:"كيك مزيّن بالورود الوردية الطبيعية والحمراء لمناسبات رومانسية",      sizes:["كبير","وسط"],        notes:["يُطلب قبل أسبوع","تصميم حسب الطلب"] },
...
function LogoMark({ size=38 }) {
  return (
    <div style={{ width:size, height:size, borderRadius:"50%", background:`linear-gradient(135deg,${C.blush},${C.pink})`, border:`2px solid ${C.gold}`, boxShadow:`0 2px 10px ${C.shadowGold}`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:size*0.45, flexShrink:0 }}>🎂</div>
  );
}
...
function WhatsAppBtn() {
  return (
    <a href={WA} target="_blank" rel="noopener noreferrer" className="wa-btn btn-press"
      style={{ position:"fixed", bottom:24, left:20, zIndex:1000, display:"flex", alignItems:"center", gap:10, background:"linear-gradient(135deg,#25D366,#1aaa55)", color:"white", borderRadius:50, padding:"13px 20px 13px 16px", boxShadow:"0 8px 28px rgba(37,211,102,0.4)", textDecoration:"none", fontSize:15, fontWeight:700, fontFamily:"'Tajawal',sans-serif" }}>
...
function Navbar({ page, setPage, catId }) {
  ...
  return (
    <nav style={{ position:"sticky", top:0, zIndex:100, background:scrolled?"rgba(255,248,250,0.96)":"transparent", backdropFilter:scrolled?"blur(14px)":"none", borderBottom:scrolled?`1px solid ${C.pink}60`:"none", transition:"all 0.35s ease", padding:"0 20px" }}>
      <div style={{ maxWidth:480, margin:"0 auto", display:"flex", alignItems:"center", justifyContent:"space-between", height:62 }}>
        ...
        <div style={{ display:"flex", gap:22, alignItems:"center" }}>
          ...
          {catId && <span className={`nav-link ${page==="category"?"active":""}`} onClick={() => setPage("category")} style={{ fontSize:14, fontWeight:600, color:page==="category"?C.deepRose:C.muted }}>المنتجات</span>}
        </div>
      </div>
    </nav>
  );
    ...
    <div className="animate-pageEnter">
      ...
      <div style={{ padding:"16px 16px 90px", maxWidth:480, margin:"0 auto" }}>
        <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
          {products.map(p => (
            <div key={p.id} className="card-hover scroll-reveal" onClick={() => { setProduct(p); setPage("product"); }}
...
<SmartImage src={p.main} alt={p.name} style={{ width:"100%", height:185, objectFit:"cover" }}/>              </div>
              <div style={{ padding:"16px 18px 18px" }}>
                ...
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                  ...
                  <span style={{ fontSize:12, fontWeight:800, color:C.deepRose, background:C.blush, borderRadius:50, padding:"7px 16px", border:`1px solid ${C.pink}40` }}>
                    عرض ←
                  </span>
                </div>
              </div>
...
function ProductPage({ product, catId, setPage }) {
  ...
  useEffect(() => { setActiveImg("main"); }, [product?.id]);
...
/>
          ...
          <div style={{ position:"absolute", inset:0, background:"linear-gradient(to bottom,transparent 40%,rgba(58,32,48,0.55))" }}/>
          {/* Back button */}
          <button onClick={() => setPage("category")} className="btn-press" style={{ position:"absolute", top:18, right:18, background:"rgba(255,255,255,0.92)", border:"none", borderRadius:50, width:42, height:42, fontSize:18, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", boxShadow:"0 4px 14px rgba(0,0,0,0.2)" }}>→</button>
          {/* Category badge */}
        ...
        <div className="thumb-strip">
          {[
            { key:"main",  src:product.main,  label:"الصورة الرئيسية" },
            { key:"thumb", src:product.thumb, label:"صورة إضافية" },
          ].map(({ key, src, label }) => (
            <button
              key={key}
            ...
            >
<SmartImage src={src} alt={label} style={{ width:"100%", height:"100%", objectFit:"cover" }}/>            </button>
          ))}
          <div style={{ flex:1 }}/>
          <span style={{ fontSize:11, color:C.muted, alignSelf:"center", fontWeight:600 }}>اضغط لعرض الصور</span>
        </div>
      </div>

      {/* Content */}
      <div style={{ padding:"24px 20px 100px", maxWidth:480, margin:"0 auto" }}>
        <h1 className="animate-fadeUp d1" style={{ fontSize:25, fontWeight:900, color:C.darkText, marginBottom:10, lineHeight:1.35 }}>
          {product.name}
        </h1>
...
export default function App() {
  ...
  return (
    <>
      ...
      <div style={{ minHeight:"100vh", background:C.cream, direction:"rtl", fontFamily:"'Tajawal',sans-serif", maxWidth:520, margin:"0 auto", position:"relative", overflowX:"hidden" }}>
